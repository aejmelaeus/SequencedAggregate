...
namespace SequencedAggregate
{
    ...
    public interface ISequencedEventStore
    {
        ...
        void CommitEvents(string id, IEnumerable<object> events);
        ...
        /// <param name="events">The events</param>
        void CommitEvents(string id, long sequenceAnchor, Guid commitId, IEnumerable<object> events);
        ...
        IEnumerable<object> GetById(string id);
    }
}